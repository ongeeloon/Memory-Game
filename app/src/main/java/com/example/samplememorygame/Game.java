...
public class Game extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view){
        ...
        //private int currChosenPic,prevChosenPic ; ImageButton ID chosen currently and previously
        // private matchedCount; how many items matched
        //private chosenCount = how many pic choose in this current hand
        // private Bitmap currBit,prevBit; previous bitmap and current bitmap for comparison;
        if(chosenCount < 2)
        {
            chosenCount++;
    ...
    protected void matchRightSound(){
        ...
        mMediaPlayer=MediaPlayer.create(this, R.raw.right);
        mMediaPlayer.start();
    }
    // wrong matching
